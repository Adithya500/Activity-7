                                 ...
                                 margin = 50)
{
    ...
    function brushed() {
        ...
        // Invert screen coordinates to data values
        const X1 = xScale.invert(selected_coordinates[0][0]);
        const X2 = xScale.invert(selected_coordinates[1][0]);
        // Note: Y-axis is inverted for D3 (top is 0, bottom is max), so we swap Y1 and Y2
    ...
    legends_items.on("click", (event, d) => {
        ...
        // 2. Select all circles that have the class matching the country name (d)
